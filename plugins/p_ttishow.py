...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        await message.reply_text(
            text=f"<b>Thankyou For Adding Me In {message.chat.title}\n\nIf you have any questions & doubts about using me contact @ROCKERSBACKUP.</b>",
            reply_markup=reply_markup)
    else:
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           ...
                                                                           InlineKeyboardButton('🔞 Adult Video 🔞', url=f'https://t.me/+Ce98xoyvoLcwYThl')
                                                                         ]]
                                                 ),
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Request Group', url="https://t.me/+VJzhxoD6GD9kNmQ1"),
